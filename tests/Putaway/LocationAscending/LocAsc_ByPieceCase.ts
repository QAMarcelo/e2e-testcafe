...
test.meta( { testType: 'regression', group: 'putaway', area: 'location Ascending', parallelizable: false } ) 
    ...
    await t.expect(await DVU.InventoryByLocation.Detail.Table.getCellValue(
        { targed: 'Available'},
        { rowTitle: 'Location', rowValue: PutawayVariables.Loc1},
        { rowTitle: 'LPN', rowValue: PutawayVariables.lpnLoc01}
    )).eql('10', `the location ${PutawayVariables.Loc1} should have an qty of 10 when Lot=WHT and SubLot=M`);
    ...
    await t.expect(await DVU.InventoryByLocation.Detail.Table.getCellValue(
        ...
        { rowTitle: 'Location', rowValue: PutawayVariables.Loc1},
        { rowTitle: 'LPN', rowValue: PutawayVariables.lpnLoc01}
    )).eql('5', `the location ${PutawayVariables.Loc1} should have an qty of 5 when Lot=BLK and SubLot=S`);
    await DVU.InventoryByLocation.Detail.CloseDialog.Click();
    ...
    await t.expect(await DVU.InventoryByLocation.Detail.Table.getCellValue(
        { targed: 'Available'},
        { rowTitle: 'Location', rowValue: PutawayVariables.Loc2},
        { rowTitle: 'LPN', rowValue: PutawayVariables.lpnLoc02}
    )).eql('12', `the location ${PutawayVariables.Loc2} should have an qty of 12 when Lot=BLK and SubLot=S`);
    await DVU.InventoryByLocation.Detail.CloseDialog.Click();
    ...
    await t.expect(await DVU.InventoryByLocation.Detail.Table.getCellValue(
        ...
        { rowTitle: 'Location', rowValue: PutawayVariables.Loc2},
        { rowTitle: 'LPN', rowValue: PutawayVariables.lpnLoc02}
    )).eql('5', `the location ${PutawayVariables.Loc2} should have an qty of 5 when Lot=BLK and SubLot=L`);
    await DVU.InventoryByLocation.Detail.CloseDialog.Click();
...
('DPD-1890: By Piece/Case - Item and Lot Code', async t =>{
    ...
    await t.expect(await DVU.InventoryByLocation.Detail.Table.getCellValue(
        ...
        { rowTitle: 'Location', rowValue: PutawayVariables.Loc1},
        { rowTitle: 'LPN', rowValue: PutawayVariables.lpnLoc01}
    )).eql('15', `the location ${PutawayVariables.Loc1} should have an qty of 15 when Lot=WHT and SubLot=M`);
    await DVU.InventoryByLocation.Detail.CloseDialog.Click();
    ...
    await t.expect(await DVU.InventoryByLocation.Detail.Table.getCellValue(
        ...
        { rowTitle: 'Location', rowValue: PutawayVariables.Loc2},
        { rowTitle: 'LPN', rowValue: PutawayVariables.lpnLoc02}
    )).eql('17', `the location ${PutawayVariables.Loc2} should have an qty of 17 when Lot=BLK and SubLot=S`);
    await DVU.InventoryByLocation.Detail.CloseDialog.Click();
    ...
    await t.expect(await DVU.InventoryByLocation.Detail.Table.getCellValue(
        ...
        { rowTitle: 'Location', rowValue: PutawayVariables.Loc2},
        { rowTitle: 'LPN', rowValue: PutawayVariables.lpnLoc02}
    )).eql('3', `the location ${PutawayVariables.Loc2} should have an qty of 3 when Lot=BLK and SubLot=L`);
    await DVU.InventoryByLocation.Detail.CloseDialog.Click();
    ...
    await t.expect(await DVU.InventoryByLocation.Detail.Table.getCellValue(
        { targed: 'Available'},
        { rowTitle: 'Location', rowValue: PutawayVariables.Loc4},
        { rowTitle: 'LPN', rowValue: PutawayVariables.lpnLoc04}
    )).eql('2', `the location ${PutawayVariables.Loc4} should have an qty of 2 when Lot=BLK and SubLot=L`);
    await DVU.InventoryByLocation.Detail.CloseDialog.Click();
});
...
('DPD-1891: By Piece/Case - Item, Lot and Sublot Code', async t =>{
    ...
    await t.expect(await DVU.InventoryByLocation.Detail.Table.getCellValue(
        ...
        { rowTitle: 'Location', rowValue: PutawayVariables.Loc4},
        { rowTitle: 'LPN', rowValue: PutawayVariables.lpnLoc04}
    )).eql('20', `the location ${PutawayVariables.Loc2} should have an qty of 20 when Lot=BLK and SubLot=L`);
    await DVU.InventoryByLocation.Detail.CloseDialog.Click();
});
...
test.meta( { testType: 'regression', group: 'putaway', area: 'location Ascending', parallelizable: false } ) 
    ('DPD-1892: By Piece/Case - Lot Code', async t =>{
        ...
        await t.expect(await DVU.InventoryByLocation.Table.getCellValue(
            ...
            { rowTitle: 'Location', rowValue: PutawayVariables.Emtpy5},
            { rowTitle: 'Lot Code', rowValue: 'WHT'},
            { rowTitle: 'Sublot Code', rowValue: 'M'},
        )).eql('10', 'the location '+PutawayVariables.Emtpy5+' should have a qty of 10 items with lot = WHT and sublot = M');
        
        //Verify Empty6 location has available qty=10 of lot=BLK and sublot=L
        await t.expect(await DVU.InventoryByLocation.Table.getCellValue(
            { targed: 'Available Qty'},
            { rowTitle: 'Location', rowValue: PutawayVariables.Emtpy6},
            { rowTitle: 'Lot Code', rowValue: 'BLK'},
            { rowTitle: 'Sublot Code', rowValue: 'L'},
        )).eql('5', 'the location '+PutawayVariables.Emtpy6+' should have a qty of 5 items wit lot = BLK and sublot L');
        ...
        await t.expect(await DVU.InventoryByLocation.Table.getCellValue(
            ...
            { rowTitle: 'Lot Code', rowValue: 'BLK'},
            { rowTitle: 'Sublot Code', rowValue: 'S'},
        )).eql('10', 'the location '+PutawayVariables.Emtpy6+' should have a qty of 10 items wit lot=BLK and sublot=S');
    
        //Verify Location1 location has available qty=5 of lot=BLK and sublot=S
        await t.expect(await DVU.InventoryByLocation.Table.getCellValue(
            { targed: 'Available Qty'},
            { rowTitle: 'Location', rowValue: PutawayVariables.Loc1}
        )).eql('5', 'the location '+PutawayVariables.Loc1+' should have a qty of 5 items wit lot=WHT and sublot=M');
    
        //Verify Location2 location has available qty=7 of lot=BLK and sublot=S
        await t.expect(await DVU.InventoryByLocation.Table.getCellValue(
            { targed: 'Available Qty'},
            { rowTitle: 'Location', rowValue: PutawayVariables.Loc2}
        )).eql('7', 'the location '+PutawayVariables.Loc2+' should have a qty of 7 items wit lot=BLK and sublot=S');
        
        //Verify Location3 location has available qty=15 of lot=WHT and sublot=L
        await t.expect(await DVU.InventoryByLocation.Table.getCellValue(
            { targed: 'Available Qty'},
            { rowTitle: 'Location', rowValue: PutawayVariables.Loc3}
        )).eql('15', 'the location '+PutawayVariables.Loc3+' should have a qty of 15 items wit lot=WHT and sublot=L');

        //Verify Location4 location has available qty=15 of lot=BLK and sublot=L
        await t.expect(await DVU.InventoryByLocation.Table.getCellValue(
            { targed: 'Available Qty'},
            { rowTitle: 'Location', rowValue: PutawayVariables.Loc4}
        )).eql('15', 'the location '+PutawayVariables.Loc4+' should have a qty of 15 items wit lot=BLK and sublot=L');
    })
...
test.meta( { testType: 'regression', group: 'putaway', area: 'location Ascending', parallelizable: false } ) 
    ('DPD-1893: By Piece/Case - SubLot Code', async t =>{
        ...
        await DVU.ItemInventory.SearchDialog.Account.Find.Search(PutawayVariables.account);
        ...
        await DVU.ItemInventory.Table.clickRowByQuery(
            { rowTitle: 'Location', rowValue: PutawayVariables.Emtpy5},
            { rowTitle: 'Lot Code', rowValue: PutawayVariables.lotWHT},
            { rowTitle: 'Sublot Code', rowValue: PutawayVariables.sublotM}
        );
        ...
        await t.expect(await DVU.ItemInventory.Detail.Table.getCellValue(
            ...
            { rowTitle: 'Location', rowValue: PutawayVariables.Emtpy5},
        )).eql('10', 'Location='+PutawayVariables.Emtpy5 + '  and no LPN should have an available qty of 10');
        ...
        await t.expect(await DVU.ItemInventory.Detail.Table.getCellValue(
            { targed: 'Available'},
            { rowTitle: 'LPN', rowValue: PutawayVariables.lpnRCV00},
            { rowTitle: 'Location', rowValue: PutawayVariables.Emtpy6},
        )).eql('10', 'Location='+PutawayVariables.Emtpy6 + '  and LPN=PA-RCV-00 should have an available qty of 10');
        await DVU.ItemInventory.Detail.CloseDialog.Click();
        ...
        await t.expect(await DVU.ItemInventory.Detail.Table.getCellValue(
            { targed: 'Available'},
            { rowTitle: 'Location', rowValue: PutawayVariables.Loc3},
            { rowTitle: 'LPN', rowValue: PutawayVariables.lpnRCV01},
        )).eql('5', 'Location='+PutawayVariables.Loc3 + '  should have an available qty of 5');
        await DVU.ItemInventory.Detail.CloseDialog.Click();
    })