    ...
    inventoryAdjustment: {
        itemAdjustment: [
            { // Receiving  | RCV-00 | t-shirt   | WHT | M       | 10
                ...
                qty: 10,
                emptyInventory: true,
                lot: PutawayVariables.lotWHT, //WHT
                sublot: PutawayVariables.sublotM, //"M",
            ...
            { // Receiving  | RCV-00 | t-shirt   | BLK | S       | 10
                ...
                lpn: PutawayVariables.lpnRCV00,
                qty: 10,
                lot: PutawayVariables.lotBLK, //"BLK",
                sublot: PutawayVariables.sublotS, //"S",
                status: InventoryAdjustment_Status.available,
                storageIdentifier: PutawayVariables.Receive,
            },
            { // Receiving  | RCV-01 | t-shirt   | BLK | L       | 3
                ...
                qty: 3,
                lot: PutawayVariables.lotBLK,  //"BLK",
                sublot: PutawayVariables.subLotL, //"L",
                status: InventoryAdjustment_Status.available,
                storageIdentifier: PutawayVariables.Receive,
            },
